export default class DemandesService {

    public static demandeList() {
        var result = [];
    ...
    public static validationDesGainsList() {
        var result = [];
        result.push({id:1, title:"Accepté"});
        result.push({id:2, title:"Refusé"});
        result.push({id:3, title:"N/A"});
        return result;
    }

    public static concernantList() {
        var result = [];
    ...
    public static validationEmissionList() {
        var result = [];
        result.push({id:1, title:"Accepté"});
        result.push({id:2, title:"Refusé"});
        result.push({id:3, title:"N/A"});
